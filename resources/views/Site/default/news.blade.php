...
@section('title', 'Tin Tức | Suất Ăn CN - Hoa Ánh Dương')
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-12 ftco-animate">
                        <div class="blog-entry d-lg-flex">
                            <div class="half">
                                <a href="single.html" class="img d-flex align-items-end" style="background-image: url({{ asset('images/image_1.jpg') }});">
                                    <div class="overlay"></div>
                                </a>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-12 ftco-animate">
                        <div class="blog-entry d-lg-flex">
                            <div class="half">
                                <a href="single.html" class="img d-flex align-items-end" style="background-image: url({{ asset('images/image_2.jpg') }});">
                                    <div class="overlay"></div>
                                </a>
                            </div>
                            <div class="text px-md-4 px-lg-5 half pt-3">
                    ...
                    <div class="col-md-6 col-lg-12 ftco-animate">
                        <div class="blog-entry d-lg-flex">
                            <div class="half">
                                <a href="single.html" class="img d-flex align-items-end" style="background-image: url({{ asset('images/image_3.jpg') }});">
                                    <div class="overlay"></div>
                                </a>
                            </div>
                            <div class="text px-md-4 px-lg-5 half pt-3">
                    ...
                    <div class="col-md-6 col-lg-12 ftco-animate">
                        <div class="blog-entry d-lg-flex">
                            <div class="half">
                                <a href="single.html" class="img d-flex align-items-end" style="background-image: url({{ asset('images/image_4.jpg') }});">
                                    <div class="overlay"></div>
                                </a>
                            </div>
                            <div class="text px-md-4 px-lg-5 half pt-3">
                    ...
                    <div class="col-md-6 col-lg-12 ftco-animate">
                        <div class="blog-entry d-lg-flex">
                            <div class="half">
                                <a href="single.html" class="img d-flex align-items-end" style="background-image: url({{ asset('images/image_5.jpg') }});">
                                    <div class="overlay"></div>
                                </a>
                            </div>
                            <div class="text px-md-4 px-lg-5 half pt-3">
                    ...
                    <div class="col-md-6 col-lg-12 ftco-animate">
                        <div class="blog-entry d-lg-flex">
                            <div class="half">
                                <a href="single.html" class="img d-flex align-items-end" style="background-image: url({{ asset('images/image_6.jpg') }});">
                                    <div class="overlay"></div>
                                </a>
                            </div>
                            <div class="text px-md-4 px-lg-5 half pt-3">
                ...
                <div class="sidebar-wrap">
                    ...
                    <div class="sidebar-box categories text-center ftco-animate">
                        ...
                        <ul class="category-image">
                            <li>
                                <a href="#" class="img d-flex align-items-center justify-content-center text-center" style="background-image: url({{ asset('images/category-1.jpg') }});">
                                    <div class="text">
                                        <h3>Foods</h3>
                                    </div>
                                </a>
                            ...
                            <li>
                                <a href="#" class="img d-flex align-items-center justify-content-center text-center" style="background-image: url({{ asset('images/category-2.jpg') }});">
                                    <div class="text">
                                        <h3>Lifestyle</h3>
                                    </div>
                                </a>
