...
@section('title', 'Thực Đơn | Suất Ăn CN - Hoa Ánh Dương')
                ...
                <div class="sidebar-wrap">
                    ...
                    <div class="sidebar-box categories text-center ftco-animate">
                        ...
                        <ul class="category-image">
                            <li>
                                <a href="#" class="img d-flex align-items-center justify-content-center text-center" style="background-image: url({{ asset('Site/images/category-1.jpg') }});">
                                    <div class="text">
                                        <h3>Foods</h3>
                                    </div>
                                </a>
