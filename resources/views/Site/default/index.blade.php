...
@section('title', 'Trang Chủ | Suất Ăn CN - Hoa Ánh Dương')
    ...
    <div class="slider-item">
        <div class="container">
            <div class="row d-flex slider-text justify-content-center align-items-center" data-scrollax-parent="true">
                ...
                <div class="img" style="background-image: url('{{ asset('site/images/bg_1.jpg') }}');"></div>
    ...
    <div class="slider-item">
        <div class="container">
            <div class="row d-flex slider-text justify-content-center align-items-center" data-scrollax-parent="true">
                ...
                <div class="img" style="background-image: url('{{ asset('site/images/bg_2.jpg') }}');"></div>
        ...
        <div class="row">
            <div class="col-md-6 order-md-last col-lg-6 ftco-animate">
                <div class="blog-entry">
                    <div class="img img-big d-flex align-items-end" style="background-image: url('{{ asset('site/images/image_2.jpg') }}');">
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-6 ftco-animate">
                        <div class="blog-entry">
                            <a href="single.html" class="img d-flex align-items-end" style="background-image: url('{{ asset('site/images/image_1.jpg') }}');">
                                <div class="overlay"></div>
                            </a>
                            <div class="text pt-3">
                    ...
                    <div class="col-md-6 ftco-animate">
                        <div class="blog-entry">
                            <a href="single.html" class="img d-flex align-items-end" style="background-image: url('{{ asset('site/images/image_3.jpg') }}');">
                                <div class="overlay"></div>
                            </a>
                            <div class="text pt-3">
                                <p class="meta d-flex"><span class="pr-3">Dessert</span><span class="ml-auto pl-3">March 01, 2018</span></p>
                    ...
                    <div class="col-md-6 ftco-animate">
                        <div class="blog-entry">
                            <a href="single.html" class="img d-flex align-items-end" style="background-image: url('{{ asset('site/images/image_4.jpg') }}');">
                                <div class="overlay"></div>
                            </a>
                            <div class="text pt-3">
                                <p class="meta d-flex"><span class="pr-3">Dessert</span><span class="ml-auto pl-3">March 01, 2018</span></p>
                    ...
                    <div class="col-md-6 ftco-animate">
                        <div class="blog-entry">
                            <a href="single.html" class="img d-flex align-items-end" style="background-image: url('{{ asset('site/images/image_5.jpg') }}');">
                                <div class="overlay"></div>
                            </a>
                            <div class="text pt-3">
                                <p class="meta d-flex"><span class="pr-3">Dessert</span><span class="ml-auto pl-3">March 01, 2018</span></p>
...
<section class="ftco-section ftco-no-pt ftco-section-about ftco-no-pb bg-darken">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-9 order-md-last img py-5" style="background-image: url('{{ asset('site/images/bg_3.jpg') }}');"></div>
            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6 ftco-animate">
                        <div class="blog-entry">
                            <div class="img img-big img-big-2 d-flex align-items-end" style="background-image: url('{{ asset('site/images/image_1.jpg') }}');">
                                <div class="overlay"></div>
                                <div class="text">
                                    <span class="subheading">Food</span>
                    ...
                    <div class="col-md-6 col-lg-6 ftco-animate">
                        <div class="blog-entry">
                            <div class="img img-big img-big-2 d-flex align-items-end" style="background-image: url('{{ asset('site/images/image_3.jpg') }}');">
                                <div class="overlay"></div>
                                <div class="text">
                ...
                <div class="sidebar-wrap pt-4">
                    <div class="sidebar-box categories text-center ftco-animate">
                        ...
                        <ul class="category-image">
                            <li>
                                <a href="foods.html" class="img d-flex align-items-center justify-content-center text-center" style="background-image: url('{{ asset('site/images/category-1.jpg') }}');">
                                    <div class="text">
                                        <h3>Foods</h3>
                                    </div>
                                </a>
                            ...
                            <li>
                                <a href="lifestyle.html" class="img d-flex align-items-center justify-content-center text-center" style="background-image: url('{{ asset('site/images/category-2.jpg') }}');">
                                    <div class="text">
                                        <h3>Lifestyle</h3>
                                    </div>
                                </a>
                            ...
                            <li>
                                <a href="#" class="img d-flex align-items-center justify-content-center text-center" style="background-image: url('{{ asset('site/images/category-2.jpg') }}');">
                                    <div class="text">
                                        <h3>Others</h3>
                                    </div>
                                </a>
    ...
    <div class="container">
        <div class="row d-flex">
            <div class="col-md-6 d-flex">
                <div class="img d-flex align-self-stretch" style="background-image:url('{{ asset('site/images/about.jpg') }}');"></div>
            </div>
