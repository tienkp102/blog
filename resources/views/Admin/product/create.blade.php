...
@section('title', 'Thêm mới sản phẩm - Admin')
@section('content')
                        ...
                        <form method="POST" action="{{ route('product.store') }}" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="card-body card-block">
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="name" placeholder="Nhập tên sản phẩm" class="form-control"><small class="form-text text-muted">Nhập tên sản phẩm</small></div>
                                </div>
                                <div class="row form-group">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><input type="number" id="text-input" name="price" placeholder="Nhập giá sản phẩm" class="form-control"><small class="form-text text-muted">Nhập giá sản phẩm</small></div>
                                </div>
                                <div class="row form-group">
